...
void main() {
  ...
  if (uLightMode > 0.5) {
    ...
    float coverage = clamp(smoothstep(0.0, 0.42, energy) * 0.74, 0.0, 0.74);
    vec3 ink = clamp(col * 0.42, 0.0, 0.78);
    gl_FragColor = vec4(mix(vec3(1.0), ink, coverage), coverage);
...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    if (mouseInteraction && !shouldReduceMotion) {
