...
`docs/ai-contribution.md` 提供两套提示词：

- 普通 AI 不能读取仓库时，先使用“纯文本面经整理”提示词获得只含正文的 Markdown，人工核对后再交给
  仓库内 AI 落盘。
- AI 能读写仓库时，直接使用“仓库内整理并落盘”提示词。AI 应先说明归档位置和计划修改的文件，确认后
  再整理内容。

面经必须忠实保留原始问题、追问和不确定信息，八股和资源推荐也必须遵守对应规范。
